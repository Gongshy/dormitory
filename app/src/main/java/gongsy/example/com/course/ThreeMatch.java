...
public class ThreeMatch extends AppCompatActivity implements View.OnClickListener{
    ...
    private Button sure;
    private String id="",loc="",id1="",vr1="",id2="",vr2="";
    EditText stuid1,stuvr1,stuid2,stuvr2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.three_match);
        Intent i=getIntent();
        id=i.getStringExtra("id");
        stuid1=(EditText)findViewById(R.id.stid1);
        stuvr1=(EditText)findViewById(R.id.stvr1);
        stuid2=(EditText)findViewById(R.id.stid2);
        stuvr2=(EditText)findViewById(R.id.stvr2);
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if(e==0){
                Intent in=new Intent(ThreeMatch.this,Success.class);
                in.putExtra("id",id);
                in.putExtra("loc",loc);
                in.putExtra("st","2");
                startActivity(in);
            }else{
                Toast.makeText(ThreeMatch.this, "未选择成功",Toast.LENGTH_LONG).show();
            }
        }
    };
    Runnable thd = new Runnable() {
        ...
        public void run() {
            ...
            try {
                ...
                String t="num=1&stuid="+id+"&stu1id="+id1+"&v1code="+vr1+"&stu1id="+id2+"&v1code="+vr2+"&buildingNo="+loc;
                URL url = new URL(ad);
